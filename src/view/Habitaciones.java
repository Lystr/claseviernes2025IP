...
public class Habitaciones extends javax.swing.JFrame {
    ...
    private void loadGridHabitacion(){
    tbl_registros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Habitacion_Id", "Ubicacion", "Acomodacion", "Costo"
            }
        ));
    }
    ...
    private void cargarDatosHabitacion(){
        ...
        for(Object habitacion_uncast : habitaciones){
            ...
            modeloTabla.addRow(new Object[]{habitacion.getId(),habitacion.getUbicacion(), habitacion.getAcomodacion(), habitacion.getCosto()});
        }
    ...
    private void goForm(String action, int id){
        view.Habitacion p1 = new view.Habitacion(this, true, action, id);
        p1.setVisible(true);
    }
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        int id = (int) modeloTabla.getValueAt(filaSeleccionado, 0);
        boolean operacion;
        operacion = habitacionDAO.delete(id);
        if(operacion){
            refreshTabla();
        }
        else{
