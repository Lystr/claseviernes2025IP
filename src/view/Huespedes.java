...
public class Huespedes extends javax.swing.JFrame {
    ...
    private void cargarDatosHuesped(){
        ...
        List<Object> huespeds = huespedDAO.getAll();
        for(Object huesped_uncast : huespeds){
            HuespedDTO huesped = (HuespedDTO) huesped_uncast;
            modeloTabla.addRow(new Object[]{huesped.getId(), huesped.getHuesped(), huesped.getEdad(), huesped.getFecha_registro()});
        }
    ...
    view.Huesped p1 = new view.Huesped(this, true, action, id);
    p1.setVisible(true);
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        operacion = huespedDAO.delete(id);
        if(operacion){
            refreshTabla();
        }
        else{
